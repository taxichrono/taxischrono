...
// champs de saisie un peu commun
...
String urlCompleted(String resference) =>
    'https://api.notchpay.co/payments/$resference'; // cette requette est envoyée en put

final decorartioncont = BoxDecoration(
...
boobtomshet(
    ...
    keys.currentState!.showBottomSheet((context) {
      return Container(
        height: hei,
        padding: EdgeInsets.all(padd ?? 12),
        decoration: BoxDecoration(
