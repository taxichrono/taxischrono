              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      DelayedAnimation(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            shape: const StadiumBorder(),
                            backgroundColor:
                                dredColor, //const Color(0xFF576dff),
                    ...
                    //         ApplicationUser.currentUser()?.listen((event) {
                    //           if (event!.userTelephone == null ||
                    //               event.userTelephone!.trim().isEmpty) {
                    //             Navigator.of(context).pop();
                    //             Navigator.of(context).push(
                    //               PageTransition(
                    //                   child: CompletteProfile(applicationUser: event),
